...
export const Route = createFileRoute("/terms")({
  head: () => ({ meta: [{ title: "قوانین و مقررات | آشنا پرفیوم" }] }),
  component: () => (
    <PageShell title="قوانین و مقررات">
      <div className="mx-auto max-w-3xl space-y-3 text-sm leading-loose text-foreground/80">
        <p>استفاده از فروشگاه آشنا پرفیوم به منزله پذیرش کلیه قوانین و مقررات زیر است. لطفاً پیش از ثبت سفارش، این موارد را مطالعه فرمایید.</p>
